 <ul class="navbar-nav sidebar sidebar-light accordion " id="accordionSidebar" style="background-color: #EB7D2D;">
     <a class="sidebar-brand d-flex align-items-center bg-gradient-primary  justify-content-center" href="index.php">
         <div class="sidebar-brand-icon">
             <img src="img\logo\literacy india logo.png">
         </div>
         <div class="sidebar-brand-text mx-3">Literacy India </div>
     </a>
